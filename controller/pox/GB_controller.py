...
from pox.lib.util import MAIN_DISPATCHER, DEAD_DISPATCHER
...
class PoxController(core.Component):
    ...
    def flow_training(self):
        ...
        X_flow_train, X_flow_test, y_flow_train, y_flow_test = train_test_split(X_flow, y_flow, test_size=.25, random_state=0)

        classifier = GradientBoostingClassifier(n_estimators=10,criterion='friedman_mse', random_state=0)
